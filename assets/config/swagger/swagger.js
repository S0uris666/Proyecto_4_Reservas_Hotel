            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  fecha: { type: "string", format: "date", example: "2023-05-15" },
                  estado: { type: "string", example: "pendiente" },
                  // Puedes agregar más campos que uses en el body
                },
                required: ["hotel", "tipo_habitacion", "num_huespedes", "fecha"],
              },
            },
          },
        },
  ...
  components: {
    schemas: {
      Reserva: {
        ...
        required: ["id", "hotel", "tipo_habitacion", "num_huespedes", "fecha"],
      },
    },
  },
};
